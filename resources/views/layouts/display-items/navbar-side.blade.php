        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                @if (session('role_aktif') == 1 || session('role_aktif') == 3)
                    <a class="nav-link collapsed menu-parent" href="#" data-toggle="collapse" data-target="#collapseLayoutsFoodOrder" aria-expanded="false" aria-controls="collapseLayouts">
                ...
                @if (session('role_aktif') == 1 || session('role_aktif') == 2)
                    <a class="nav-link collapsed menu-parent" href="#" data-toggle="collapse" data-target="#collapseLayoutsCustOrder" aria-expanded="false" aria-controls="collapseLayouts">
