...
<div class="container my-5">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group my-4">
            <label>Nama</label>
            <input type="text" name="nama" required class="form-control my-2" value="{{ old('nama') }}" placeholder="Tenderloin Steak">
        </div>
        <div class="my-4 text-danger text-left">
            @error('nama')
                {{ $message }}
        ...
        <div class="form-group my-4">
            <label>Harga</label>
            <input type="number" name="harga" required class="form-control my-2" value="{{ old('harga') }}" placeholder="85000">
        </div>
        <div class="my-4 text-danger text-left">
            @error('harga')
                {{ $message }}
